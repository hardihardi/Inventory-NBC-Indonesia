    ...
    <div class="container" style="max-width: 450px;">
        <div class="card p-4">
            <div class="text-center mb-4">
                ...
                <p class="text-muted small">Masukkan email Anda untuk menerima instruksi reset password.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('login') }}" class="btn btn-link link-secondary small">Kembali ke Login</a>
                </div>
            </form>
        </div>
    </div>
